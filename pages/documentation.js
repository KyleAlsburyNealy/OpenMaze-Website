          ...
          <div className="flex flex-wrap justify-center m-0 mx-4 md:mx-0">
            ...
            <div className="flex-1 w-full flex flex-wrap flex-col items-center mt-6 md:mt-0">
              ...
              <div className="text-white text-left max-w-sm md:max-w-lg lg:max-w-2xl mb-16" id="scenesBuild">
                ...
                <p>As you will notice, the 3D Environment Scene is empty. That is because OpenMaze does not come with any pre-built 3D environments. Instead, we have left it up to you to create 3D environments that are perfectly suited to meet the needs of your experiment design.</p><br />
              ...
              <div className="text-white text-left max-w-sm md:max-w-lg lg:max-w-2xl mb-16" id="gExamples">
               ...
               <div className="text-white text-left max-w-sm md:max-w-lg lg:max-w-2xl mb-16" id="configE">
                  ...
                  <div style={{padding: 20}}>
                    ...
                    <b>Step 2: Add a reference Attribute-Value Pair</b>
                    <p>We recommend including a description Attribute-Value Pair in the form: “Enclosure #”: “Description”. The "#" corresponds to the <i>Enclosure's</i> index number which will be used when creating <i>Trials</i> and "Description" can be replaced with identifying information of your choosing. </p><br />
                    <br />
                ...
                <h3 id="About" className="font-medium text-3xl"><i>Trial</i> Indexing</h3>
                  ...
                  <div style={{padding: 20}}>
                    ...
                    <p>Set the Value of the Scene Attribute to the <a href = "#sceneUse"><u>Scene Number</u></a> of the Scene you want the <i>Task Trial</i> to take place in.</p>
                    <br/>

                    <b>Step 4: Participant Placement</b>
                    <p>Use the StartPosition Attribute to dictate the participants x,z Position Values and the StartFacing Attribute to dictate the participants Rotation about the y-axis.</p><br/>
                    <br/>
                    ...
                    <div class="bg-gray-600 rounded-lg border text-center border-white p-4">
                        <p><strong>Note:</strong> When a participant reaches the Quota the <i>Task Trial</i> is recorded as a success by OpenMaze. <i>Task Trial</i> successes can be used to create performance criterion (see <i><b>Blocks</b></i> Section below).</p>
                    </div>
                    <br/>
                  ...
                  <table className="table-auto">
                    ...
                    <tr >
                      ...
                      <tr>
                        ...
                        <td className=" px-4 py-2">60</td>
                        <td className=" px-4 py-2">Length of Trial in seconds. <i>Task Trial</i> will time out if Quota is not met and TrialEndKey is not pressed. Upon timeout the experiment will proceed to the next <i>Trial</i> as defined in the Block section.</td>
                      </tr>
                      <tr className="bg-dark-light">
                  ...
                  <table className="table-auto">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className=" px-4 py-2">Used to adjust how often per second the experiment records a new line of data to the output file. Output is intrinsically linked to the Unity software <b>Update()</b> function which is itself intrinsically linked to the refresh rate of the monitor running the experiment. This number can be used to reduce the output rate below the update cycle rate, but not above.</td>
                      </tr>
                      <tr className="bg-dark-light">
                        <td className=" px-4 py-2">IgnoreUserInputDelay</td>
                        <td className=" px-4 py-2">0.5</td>
                        <td className=" px-4 py-2">Time in seconds after each Trial onset that input will be ignored. We recommend using a 1 second delay to ensure that accidental key presses do not cause <i>Trials</i> to be skipped when consecutive <i>Trials</i> use the same TrialEndKey.</td>
                      </tr>
                      <tr>
              ...
              <h2 className="font-medium text-center text-6xl my-2">Testing Experiments</h2>
                ...
                <div style={{padding: 20}}>
                  ...
                  <p>Most commonly, if you encounter an unexpected error when attempting to run a Configuration File, it is likely a JSON formatting issue. 
                    ...
                    Configuration File has any issues. Alternatively, while much more tedious, you can copy and paste your JSON file text into an online JSON lint (e.g. <a href= "https://jsonlint.com/" target="_blank">https://jsonlint.com/</a>).</p><br />
